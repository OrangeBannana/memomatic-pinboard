...
FILES = [
    ...
    ("app/bt_agent.py",               f"{PI_HOME}/app/bt_agent.py"),
    ("systemd/pinboard-app.service",  "/tmp/pinboard-app.service"),
    ("systemd/pinboard-bluetooth.service", "/tmp/pinboard-bluetooth.service"),
...
def main():
    ...
    commands = [
        ...
        "sudo cp /tmp/pinboard-bluetooth.service /etc/systemd/system/pinboard-bluetooth.service",
        "sudo chmod +x /tmp/memomatic-install.sh",
        "sudo chmod +x /home/memomatic/pinboard/app/touch_bridge.py",
        "sudo chmod +x /home/memomatic/pinboard/app/bt_agent.py",
        "sudo systemctl daemon-reload",
        "sudo systemctl enable pinboard-app.service pinboard-kiosk.service pinboard-touch.service pinboard-splash.service pinboard-bluetooth.service",
        ...
        "sudo systemctl restart pinboard-bluetooth.service",
        "echo DONE",
    ]
